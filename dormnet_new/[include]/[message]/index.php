	...
	<form method="post">
		<table class="msg_box" align="center" style="text-align:center">
			...
			<tr>
				...
				<td>
					<input type="text" width="150px" name="msg_name" value=" "/>
				</td>
			</tr>
			...
			<tr>
				<td colspan="2">
					<textarea  style="width:220px; height:100px" name="msg_content">
</textarea>
				</td>
			</tr>
    ...
    function output($n)
    {
	    ...
	    if($tmp['replyid']==0)
	    {
	    	$n += 1;
            	...
            	echo  "<tr><td colspan='2'>Message:<br/>б@б@" . htmlspecialchars( $tmp['msg'] ). "</td></tr>";
		...
		foreach( $sth2 as $tmp2 )
			...
			//echo  "<table class='msgtable left' >";
                	echo  "<tr><td colspan='2'>б@б@>" . htmlspecialchars( $tmp2['msg'] ) . "</td></tr>";
